...
// Using lucide-react for icons. You would need to install it:
// npm install lucide-react
// Or you can replace these with your own SVGs.
import {
  LayoutDashboard,
  Mail,
  Globe,
  ...
  `}
    ...
    `}
            ...
            >
              <LogOut
                size={20}
                className={`flex-shrink-0 ${isSidebarOpen ? "mr-3" : "hidden md:block"
                  }`}
              />
